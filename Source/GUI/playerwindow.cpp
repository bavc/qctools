...
{
    assert(QGuiApplication::instance()->thread()->currentThreadId() == thread()->currentThreadId());
...
void PlayerWindow::setFilter(QString filter)
{
