...
percolumn PerColumn[Col_Max]=
{
  ...
  //{ StatsType_None,       Item_VideoMax,          Item_VideoMax,          "Encoder",          NULL, },
    ...
    { StatsType_Average,    Item_BPN_Y1,            Item_VideoMax,          "Avg Bit 1 Y",      "Average signal to noise of 1st bit (least significant) in Y plane", },
    { StatsType_Average,    Item_BPN_Y2,            Item_VideoMax,          "Avg Bit 2 Y",      "Average signal to noise of 2nd bit in Y plane", },
    { StatsType_Average,    Item_BPN_Y3,            Item_VideoMax,          "Avg Bit 3 Y",      "Average signal to noise of 3rd bit in Y plane", },
    { StatsType_Average,    Item_BPN_Y4,            Item_VideoMax,          "Avg Bit 4 Y",      "Average signal to noise of 4th bit in Y plane", },
    { StatsType_Average,    Item_BPN_U1,            Item_VideoMax,          "Avg Bit 1 U",      "Average signal to noise of 1st bit (least significant) in U plane", },
    { StatsType_Average,    Item_BPN_U2,            Item_VideoMax,          "Avg Bit 2 U",      "Average signal to noise of 2nd bit in U plane", },
    { StatsType_Average,    Item_BPN_U3,            Item_VideoMax,          "Avg Bit 3 U",      "Average signal to noise of 3rd bit in U plane", },
    { StatsType_Average,    Item_BPN_U4,            Item_VideoMax,          "Avg Bit 4 U",      "Average signal to noise of 4th bit in U plane", },
    { StatsType_Average,    Item_BPN_V1,            Item_VideoMax,          "Avg Bit 1 V",      "Average signal to noise of 1st bit (least significant) in V plane", },
    { StatsType_Average,    Item_BPN_V2,            Item_VideoMax,          "Avg Bit 2 V",      "Average signal to noise of 2nd bit in V plane", },
    { StatsType_Average,    Item_BPN_V3,            Item_VideoMax,          "Avg Bit 3 V",      "Average signal to noise of 3rd bit in V plane", },
    { StatsType_Average,    Item_BPN_V4,            Item_VideoMax,          "Avg Bit 4 V",      "Average signal to noise of 4th bit in V plane", },
