...
//---------------------------------------------------------------------------
VideoStats::VideoStats (size_t TypePos, size_t FrameCount, double Duration, double Frequency_)
    :
    CommonStats(VideoPerItem, Type_Video, TypePos, Group_VideoMax, Item_VideoMax, FrameCount, Duration, Frequency_)
{
}
