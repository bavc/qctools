...
public:
    ...
    CommonStats(const struct per_item* PerItem, int Type, int TypePos, size_t CountOfGroups, size_t CountOfItems, size_t FrameCount=0, double Duration=0, double Frequency=0);
    virtual ~CommonStats();
