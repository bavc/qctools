...
struct per_group VideoPerGroup [Group_VideoMax]=
{
    ...
    //YDiff
    {
        Item_YDIF,      1,    "0",  nullptr,  3,  "YDiff", false,
    ...
    //UDiff
    {
        Item_UDIF,      1,    "0",  nullptr,  3,  "UDiff", false,
    ...
    //VDiff
    {
        Item_VDIF,      1,    "0",  nullptr,  3,  "VDiff", false,
    ...
    //Diffs
    {
        Item_VDIF,      3,    "0",  nullptr,  3,  "Diffs",  true,
    ...
    //TOUT
    {
        Item_TOUT,      1,    "0",  nullptr,  4,  "TOUT", false,
    ...
    //VREP
    {
        Item_VREP,      1,    "0",  nullptr,  4,  "VREP", false,
    ...
    //BRNG
    {
        Item_BRNG,      1,    "0",  nullptr,  4,  "BRNG", false,
    ...
    //CropH
    {
        Item_Crop_y1,   2,    "0",  nullptr,  4,  "CropH", false,
    ...
    //CropF
    {
        Item_Crop_w,   2,    "0",  nullptr,  4,  "CropF", false,
    ...
    //MSEf
    {
        Item_MSE_v,     3,    "0",  nullptr,  4,  "MSEf", false,
    ...
    //PSNRf
    {
        Item_PSNR_v,    3,    "0",  nullptr,  4,  "PSNRf", false,
        "Plots an assessment of visual difference of field 1 versus field 2 via\n"
    ...
    //SSIMf
    {
        Item_SSIM_Y,    4,    "0",  nullptr,  4,  "SSIMf", false,
        "Plots an assessment of visual difference of field 1 versus field 2 via\n"
    ...
    {
        Item_pkt_duration_time,     1,    "0",  nullptr,  4,  "pkt_duration_time", false,
    ...
    //Item_pkt_size
    {
        Item_pkt_size,     1,    "0",  nullptr,  4,  "pkt_size", false,
...
const struct per_item VideoPerItem [Item_VideoMax]=
{
    ...
    //U
    { Group_U,       Group_VideoMax,       "U MIN",         "lavfi.signalstats.UMIN",    0,   false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_U,       Group_VideoMax,       "U LOW",         "lavfi.signalstats.ULOW",    0,   false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_U,       Group_VideoMax,       "U AVG",         "lavfi.signalstats.UAVG",    0,   false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_U,       Group_VideoMax,       "U HIGH",        "lavfi.signalstats.UHIGH",   0,   false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_U,       Group_VideoMax,       "U MAX",         "lavfi.signalstats.UMAX",    0,   true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    //V
    { Group_V,       Group_VideoMax,       "V MIN",         "lavfi.signalstats.VMIN",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_V,       Group_VideoMax,       "V LOW",         "lavfi.signalstats.VLOW",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_V,       Group_VideoMax,       "V AVG",         "lavfi.signalstats.VAVG",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_V,       Group_VideoMax,       "V HIGH",        "lavfi.signalstats.VHIGH",   0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_V,       Group_VideoMax,       "V MAX",         "lavfi.signalstats.VMAX",    0,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    //Diffs
    { Group_VDiff,   Group_Diffs,           "V DIF",        "lavfi.signalstats.VDIF",    5,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_UDiff,   Group_Diffs,           "U DIF",        "lavfi.signalstats.UDIF",    5,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_YDiff,   Group_Diffs,           "Y DIF",        "lavfi.signalstats.YDIF",    5,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    //Sat
    { Group_Sat,     Group_VideoMax,       "SAT MIN",       "lavfi.signalstats.SATMIN",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_Sat,     Group_VideoMax,       "SAT LOW",       "lavfi.signalstats.SATLOW",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_Sat,     Group_VideoMax,       "SAT AVG",       "lavfi.signalstats.SATAVG",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_Sat,     Group_VideoMax,       "SAT HIGH",      "lavfi.signalstats.SATHIGH", 0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_Sat,     Group_VideoMax,       "SAT MAX",       "lavfi.signalstats.SATMAX",  0,  true,      88.7,   118.2, ActiveFilter_Video_signalstats },
    //Hue
    { Group_Hue,     Group_VideoMax,       "HUE MED",       "lavfi.signalstats.HUEMED",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    { Group_Hue,     Group_VideoMax,       "HUE AVG",       "lavfi.signalstats.HUEAVG",  0,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats },
    //Others
    ...
    { Group_CropH,   Group_VideoMax,       "Crop Top",      "lavfi.cropdetect.y1",       0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_cropdetect  },
    { Group_CropH,   Group_VideoMax,       "Crop Bottom",   "lavfi.cropdetect.y2",       0,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_cropdetect  },
    { Group_CropF,   Group_VideoMax,       "Crop Width",    "lavfi.cropdetect.w",        0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_cropdetect  },
    { Group_CropF,   Group_VideoMax,       "Crop Height",   "lavfi.cropdetect.h",        0,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_cropdetect  },
    //MSEf
    { Group_MSE,     Group_VideoMax,       "MSEf V",        "lavfi.psnr.mse.v",          2,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr },
    { Group_MSE,     Group_VideoMax,       "MSEf U",        "lavfi.psnr.mse.u",          2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr  },
    { Group_MSE,     Group_VideoMax,       "MSEf Y",        "lavfi.psnr.mse.y",          2,  false,     1000, DBL_MAX, ActiveFilter_Video_Psnr  },
    //PSNRf
    { Group_PSNR,    Group_VideoMax,       "PSNRf V",       "lavfi.psnr.psnr.v",         2,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr  },
    { Group_PSNR,    Group_VideoMax,       "PSNRf U",       "lavfi.psnr.psnr.u",         2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr  },
    { Group_PSNR,    Group_VideoMax,       "PSNRf Y",       "lavfi.psnr.psnr.y",         2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr  },
    //SSIMf
    { Group_SSIM,    Group_VideoMax,       "SSIMf All",     "lavfi.ssim.All",            2,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim },
    { Group_SSIM,    Group_VideoMax,       "SSIMf V",       "lavfi.ssim.V",              2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim  },
    { Group_SSIM,    Group_VideoMax,       "SSIMf U",       "lavfi.ssim.U",              2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim  },
    { Group_SSIM,    Group_VideoMax,       "SSIMf Y",       "lavfi.ssim.Y",              2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim  },
    //IDET.single
    { Group_IDET_S,    Group_VideoMax,     "s.bff",         "lavfi.idet.single.bff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet },
    { Group_IDET_S,    Group_VideoMax,     "s.tff",         "lavfi.idet.single.tff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet  },
    { Group_IDET_S,    Group_VideoMax,     "s.prog",        "lavfi.idet.single.progressive",      2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet  },
    { Group_IDET_S,    Group_VideoMax,     "s.und",         "lavfi.idet.single.undetermined",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet  },
    //IDET.multiple
    { Group_IDET_M,    Group_VideoMax,     "m.bff",         "lavfi.idet.multiple.bff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet  },
    { Group_IDET_M,    Group_VideoMax,     "m.tff",         "lavfi.idet.multiple.tff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet  },
    { Group_IDET_M,    Group_VideoMax,     "m.prog",        "lavfi.idet.multiple.progressive",      2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet  },
    { Group_IDET_M,    Group_VideoMax,     "m.und",         "lavfi.idet.multiple.undetermined",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet  },
    //IDET.repeat
