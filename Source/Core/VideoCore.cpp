...
{
    //Y
    { Group_Y,       Group_VideoMax,       "YMIN",          "lavfi.signalstats.YMIN",    0,   false,  DBL_MAX, DBL_MAX },
    { Group_Y,       Group_VideoMax,       "YLOW",          "lavfi.signalstats.YLOW",    0,   false,  DBL_MAX, DBL_MAX },
    { Group_Y,       Group_VideoMax,       "YAVG",          "lavfi.signalstats.YAVG",    0,   false,  DBL_MAX, DBL_MAX },
    { Group_Y,       Group_VideoMax,       "YHIGH",         "lavfi.signalstats.YHIGH",   0,   false,  DBL_MAX, DBL_MAX },
    { Group_Y,       Group_VideoMax,       "YMAX",          "lavfi.signalstats.YMAX",    0,   true,   DBL_MAX, DBL_MAX },
    //U
    { Group_U,       Group_VideoMax,       "UMIN",          "lavfi.signalstats.UMIN",    0,   false,  DBL_MAX, DBL_MAX },
    { Group_U,       Group_VideoMax,       "ULOW",          "lavfi.signalstats.ULOW",    0,   false,  DBL_MAX, DBL_MAX },
    { Group_U,       Group_VideoMax,       "UAVG",          "lavfi.signalstats.UAVG",    0,   false,  DBL_MAX, DBL_MAX },
    { Group_U,       Group_VideoMax,       "UHIGH",         "lavfi.signalstats.UHIGH",   0,   false,  DBL_MAX, DBL_MAX },
    { Group_U,       Group_VideoMax,       "UMAX",          "lavfi.signalstats.UMAX",    0,   true,   DBL_MAX, DBL_MAX },
    //V
    { Group_V,       Group_VideoMax,       "VMIN",          "lavfi.signalstats.VMIN",    0,  false,  DBL_MAX, DBL_MAX },
    { Group_V,       Group_VideoMax,       "VLOW",          "lavfi.signalstats.VLOW",    0,  false,  DBL_MAX, DBL_MAX },
    { Group_V,       Group_VideoMax,       "VAVG",          "lavfi.signalstats.VAVG",    0,  false,  DBL_MAX, DBL_MAX },
    { Group_V,       Group_VideoMax,       "VHIGH",         "lavfi.signalstats.VHIGH",   0,  false,  DBL_MAX, DBL_MAX },
    { Group_V,       Group_VideoMax,       "VMAX",          "lavfi.signalstats.VMAX",    0,  true,   DBL_MAX, DBL_MAX },
    //Diffs
    { Group_VDiff,   Group_Diffs,           "VDIF",         "lavfi.signalstats.VDIF",    5,  false,  DBL_MAX, DBL_MAX },
    { Group_UDiff,   Group_Diffs,           "UDIF",         "lavfi.signalstats.UDIF",    5,  false,  DBL_MAX, DBL_MAX },
    { Group_YDiff,   Group_Diffs,           "YDIF",         "lavfi.signalstats.YDIF",    5,  false,  DBL_MAX, DBL_MAX },
    //Sat
    { Group_Sat,     Group_VideoMax,       "SATMIN",        "lavfi.signalstats.SATMIN",  0,  false,  DBL_MAX, DBL_MAX },
    { Group_Sat,     Group_VideoMax,       "SATLOW",        "lavfi.signalstats.SATLOW",  0,  false,  DBL_MAX, DBL_MAX },
    { Group_Sat,     Group_VideoMax,       "SATAVG",        "lavfi.signalstats.SATAVG",  0,  false,  DBL_MAX, DBL_MAX },
    { Group_Sat,     Group_VideoMax,       "SATHIGH",       "lavfi.signalstats.SATHIGH", 0,  false,  DBL_MAX, DBL_MAX },
    { Group_Sat,     Group_VideoMax,       "SATMAX",        "lavfi.signalstats.SATMAX",  0,  true,      88.7,   118.2 },
    //Hue
    { Group_Hue,     Group_VideoMax,       "HUEMED",        "lavfi.signalstats.HUEMED",  0,  false,  DBL_MAX, DBL_MAX },
    { Group_Hue,     Group_VideoMax,       "HUEAVG",        "lavfi.signalstats.HUEAVG",  0,  true,   DBL_MAX, DBL_MAX },
    //Others
