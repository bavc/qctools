...
const struct per_item VideoPerItem [Item_VideoMax]=
{
    ...
    { Group_U,       Group_VideoMax,       "U AVG",         "lavfi.signalstats.UAVG",    0,   false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1 },
    { Group_U,       Group_VideoMax,       "U HIGH",        "lavfi.signalstats.UHIGH",   0,   false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1 },
    { Group_U,       Group_VideoMax,       "U MAX",         "lavfi.signalstats.UMAX",    0,   true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    //V
    { Group_V,       Group_VideoMax,       "V MIN",         "lavfi.signalstats.VMIN",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_V,       Group_VideoMax,       "V LOW",         "lavfi.signalstats.VLOW",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_V,       Group_VideoMax,       "V AVG",         "lavfi.signalstats.VAVG",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_V,       Group_VideoMax,       "V HIGH",        "lavfi.signalstats.VHIGH",   0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_V,       Group_VideoMax,       "V MAX",         "lavfi.signalstats.VMAX",    0,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    //Diffs
    { Group_VDiff,   Group_Diffs,           "V DIF",        "lavfi.signalstats.VDIF",    5,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_UDiff,   Group_Diffs,           "U DIF",        "lavfi.signalstats.UDIF",    5,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_YDiff,   Group_Diffs,           "Y DIF",        "lavfi.signalstats.YDIF",    5,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    //Sat
    { Group_Sat,     Group_VideoMax,       "SAT MIN",       "lavfi.signalstats.SATMIN",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_Sat,     Group_VideoMax,       "SAT LOW",       "lavfi.signalstats.SATLOW",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_Sat,     Group_VideoMax,       "SAT AVG",       "lavfi.signalstats.SATAVG",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_Sat,     Group_VideoMax,       "SAT HIGH",      "lavfi.signalstats.SATHIGH", 0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_Sat,     Group_VideoMax,       "SAT MAX",       "lavfi.signalstats.SATMAX",  0,  true,      88.7,   118.2, ActiveFilter_Video_signalstats, nullptr, -1  },
    //Hue
    { Group_Hue,     Group_VideoMax,       "HUE MED",       "lavfi.signalstats.HUEMED",  0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_Hue,     Group_VideoMax,       "HUE AVG",       "lavfi.signalstats.HUEAVG",  0,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    //Others
    { Group_TOUT,    Group_VideoMax,       "TOUT",          "lavfi.signalstats.TOUT",    8,  false,    0.005, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_VREP,    Group_VideoMax,       "VREP",          "lavfi.signalstats.VREP",    8,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_BRNG,    Group_VideoMax,       "BRNG",          "lavfi.signalstats.BRNG",    8,  true,      0.05, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    //Bitdepths
    { Group_YUVB,    Group_VideoMax,       "V Active Bits", "lavfi.signalstats.VBITDEPTH",    0,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_YUVB,    Group_VideoMax,       "U Active Bits", "lavfi.signalstats.UBITDEPTH",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    { Group_YUVB,    Group_VideoMax,       "Y Active Bits", "lavfi.signalstats.YBITDEPTH",    0,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_signalstats, nullptr, -1  },
    //Crop
    ...
    //MSEf
    { Group_MSE,     Group_VideoMax,       "MSEf V",        "lavfi.psnr.mse.v",          2,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr, nullptr, -1  },
    { Group_MSE,     Group_VideoMax,       "MSEf U",        "lavfi.psnr.mse.u",          2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr, nullptr, -1   },
    { Group_MSE,     Group_VideoMax,       "MSEf Y",        "lavfi.psnr.mse.y",          2,  false,     1000, DBL_MAX, ActiveFilter_Video_Psnr, nullptr, -1   },
    //PSNRf
    { Group_PSNR,    Group_VideoMax,       "PSNRf V",       "lavfi.psnr.psnr.v",         2,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr, nullptr, -1   },
    { Group_PSNR,    Group_VideoMax,       "PSNRf U",       "lavfi.psnr.psnr.u",         2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr, nullptr, -1   },
    { Group_PSNR,    Group_VideoMax,       "PSNRf Y",       "lavfi.psnr.psnr.y",         2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Psnr, nullptr, -1   },
    //SSIMf
    { Group_SSIM,    Group_VideoMax,       "SSIMf All",     "lavfi.ssim.All",            2,  true,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim, nullptr, -1  },
    { Group_SSIM,    Group_VideoMax,       "SSIMf V",       "lavfi.ssim.V",              2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim, nullptr, -1   },
    { Group_SSIM,    Group_VideoMax,       "SSIMf U",       "lavfi.ssim.U",              2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim, nullptr, -1   },
    { Group_SSIM,    Group_VideoMax,       "SSIMf Y",       "lavfi.ssim.Y",              2,  false,  DBL_MAX, DBL_MAX, ActiveFilter_Video_Ssim, nullptr, -1   },
    //IDET.single
    { Group_IDET_S,    Group_VideoMax,     "s.bff",         "lavfi.idet.single.bff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1  },
    { Group_IDET_S,    Group_VideoMax,     "s.tff",         "lavfi.idet.single.tff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    { Group_IDET_S,    Group_VideoMax,     "s.prog",        "lavfi.idet.single.progressive",      2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    { Group_IDET_S,    Group_VideoMax,     "s.und",         "lavfi.idet.single.undetermined",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    //IDET.multiple
    { Group_IDET_M,    Group_VideoMax,     "m.bff",         "lavfi.idet.multiple.bff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    { Group_IDET_M,    Group_VideoMax,     "m.tff",         "lavfi.idet.multiple.tff",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    { Group_IDET_M,    Group_VideoMax,     "m.prog",        "lavfi.idet.multiple.progressive",      2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    { Group_IDET_M,    Group_VideoMax,     "m.und",         "lavfi.idet.multiple.undetermined",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    //IDET.repeat
    { Group_IDET_R,    Group_VideoMax,     "bottom",        "lavfi.idet.repeated.bottom", 2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    { Group_IDET_R,    Group_VideoMax,     "top",           "lavfi.idet.repeated.top",    2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    { Group_IDET_R,    Group_VideoMax,     "neither",       "lavfi.idet.repeated.neither",     2,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Idet, nullptr, -1   },
    //DEFL
    { Group_DEFL,      Group_VideoMax,     "flicker",       "lavfi.deflicker.relative_change",     5,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Deflicker, nullptr, -1   },
    //ENTR
    { Group_ENTR,      Group_VideoMax,     "V ENT",         "lavfi.entropy.normalized_entropy.normal.V",  5,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Entropy, nullptr, -1   },
    { Group_ENTR,      Group_VideoMax,     "U ENT",         "lavfi.entropy.normalized_entropy.normal.U",  5,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Entropy, nullptr, -1   },
    { Group_ENTR,      Group_VideoMax,     "Y ENT",         "lavfi.entropy.normalized_entropy.normal.Y",  5,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_Entropy, nullptr, -1   },
    //ENTR-DIFF
    { Group_ENTRD,     Group_VideoMax,     "V ENT DIF",     "lavfi.entropy.normalized_entropy.diff.V",  5,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_EntropyDiff, nullptr, -1   },
    { Group_ENTRD,     Group_VideoMax,     "U ENT DIF",     "lavfi.entropy.normalized_entropy.diff.U",  5,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_EntropyDiff, nullptr, -1   },
    { Group_ENTRD,     Group_VideoMax,     "Y ENT DIF",     "lavfi.entropy.normalized_entropy.diff.Y",  5,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_EntropyDiff, nullptr, -1   },
    // pkt_duration_time & pkt_size
    { Group_pkt_duration_time, Group_VideoMax,     "pkt_duration_time",        "pkt_duration_time", 5,  false,   DBL_MAX, DBL_MAX, (activefilter) -1, nullptr, -1  },
    { Group_pkt_size,  Group_VideoMax,     "pkt_size",      "pkt_size",                  0,  false,   DBL_MAX, DBL_MAX, (activefilter) -1, nullptr, -1  },
    // block and blur detections
    { Group_blockdetect, Group_VideoMax,     "blockiness",     "lavfi.block",            6,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_blockdetect, nullptr, -1  },
    { Group_blurdetect,  Group_VideoMax,     "blurriness",     "lavfi.blur",             6,  false,   DBL_MAX, DBL_MAX, ActiveFilter_Video_blurdetect, nullptr, -1  },
